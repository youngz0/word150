...
lst.extend(lst2)
lst = '三 正 去 五 百 甘 支 卡 白 田 古 丫 末 羊 勺 自 禾 反 币 儿 斤 井 大 火 央 在 戊 成 父 米 交 之 芝 达 令 主 冬 小 穴 农 内 么 只 书 西 见 因 山 牙 岁 匠 买 尔 空 寸 乎 余 子 狂 孔 戈 代 民 必 习 虫 式 长 氏 良 木 丰 人 个 本 它 云 亏 川 叶 月 凡 闪 水 义 门 衣 犬 发 龙 叉 左 厅 句 可 匀 过 处 凶 凤 网 巨 匹 天 方 一 立 山2 古2'.split(' ')
lst = '人'.split(' ')
